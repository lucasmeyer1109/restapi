...
class DisciplinaController {
	...
	public DisciplinaController() {
		...
		disciplinas.add(new Disciplina(1, "Neymar", "S", "Matematica", 3));
		disciplinas.add(new Disciplina(2, "Thomaz", "C", "Ciencias", 2));
		disciplinas.add(new Disciplina(3, "Jubileu", "D", "Administração", 4));
	}
